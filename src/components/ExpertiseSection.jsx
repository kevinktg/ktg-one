...
export function ExpertiseSection() {
  ...
  useGSAP(() => {
    // Phase 1: Shutter reveal on scroll start
    ...
    // Phase 5: Fade out white overlay at bottom
    gsap.to(".expertise-fade-out", {
      opacity: 1,
      duration: 1,
      ease: "power2.inOut",
      scrollTrigger: {
  ...
  return (
    <section ref={containerRef} className="relative h-screen bg-white text-black overflow-hidden">
      ...
      <div className="expertise-fade-out absolute inset-0 bg-white pointer-events-none z-50" style={{ opacity: 0 }} />
      ...
      {/* Main Content */}
      <div ref={contentRef} className="relative z-20 w-full flex flex-col justify-center py-20 px-6">
