...
export const GeometricBackground = memo(function GeometricBackground({ fixed = false }) {
  return (
    ...
    >
      ...
      <ul className="background opacity-30">
      ...
      <div className="absolute top-20 right-20 w-64 h-64 border-2 border-white/5 rotate-45" />
      <div className="absolute top-1/4 left-10 w-48 h-48 border-2 border-white/5" />
      <div className="absolute bottom-1/4 right-1/3 w-96 h-96 border-2 border-white/5 rounded-full" />
